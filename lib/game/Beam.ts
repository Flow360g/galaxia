 ...
 * over `seconds` then faded. Used for our shot (cyan) and the scout's return
 * fire (red), and for nothing else: a beam on screen means a gun has gone
 * off, never that one is being aimed.
 */
